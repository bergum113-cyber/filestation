...
<head>
  ...
  <script type="module" crossorigin src="index-DbPVRDJn.js?v=<?php echo APP_VERSION; ?>"></script>
  <link rel="stylesheet" crossorigin href="index-BCYJGuoE.css?v=<?php echo APP_VERSION; ?>">
</head>
<body>
  <div id="studio-root">
    <!-- 메뉴바 -->
