...
<head>
  ...
  <script type="module" crossorigin src="index-EQbwmbnL.js?v=<?php echo APP_VERSION; ?>"></script>
  <link rel="stylesheet" crossorigin href="index-C_SbAHsx.css?v=<?php echo APP_VERSION; ?>">
</head>
<body>
  <div id="studio-root">
    <!-- 메뉴바 -->
